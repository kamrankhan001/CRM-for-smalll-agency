              ...
              <div class="flex gap-3 pt-4">
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger as-child>
                      <div class="inline-block flex-1">
                        <Button 
                          type="submit" 
                          class="w-full gap-2"
                          :disabled="form.processing || !form.title || !form.date"
                        >
                    ...
                    <TooltipContent v-if="form.processing || !form.title || !form.date">
                      <p v-if="form.processing">Creating appointment...</p>
                      <p v-else-if="!form.title">Title is required</p>
        ...
        <div class="space-y-6">
          ...
          <Card class="border">
            ...
            <CardContent class="space-y-4 text-sm">
              <!-- Pending -->
              <div class="space-y-2 rounded-lg border border-yellow-500/20 bg-yellow-500/5 p-4">
                <div class="flex items-center gap-2">
                  <div class="h-2.5 w-2.5 rounded-sm bg-yellow-500"></div>
