...
const showingFrom = computed(() => {
    ...
    return props.leads.meta.from || (props.leads.meta.current_page - 1) * props.leads.meta.per_page + 1
})

const showingTo = computed(() => {
    if (!props.leads.meta || props.leads.data.length === 0) return 0
    return props.leads.meta.to || Math.min(props.leads.meta.current_page * props.leads.meta.per_page, props.leads.meta.total)
})
            ...
            <TableRow v-for="lead in leads.data" :key="lead.id">
              <TableCell class="font-medium">
                <div class="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div v-if="lead.source" class="text-xs text-muted-foreground">
                      via {{ lead.source }}
                    </div>
                  </div>
                </div>
              ...
              <TableCell>
                <ActionButtons
                  ...
                  :on-delete="() => confirmDelete(lead.id)"
                />
              </TableCell>
            </TableRow>
                ...
                >
                  ...
                  >
                    ...
                    <button
                      ...
                      :disabled="!leads.links[leads.links.length - 1].url"
                      @click="goToPage(leads.links[leads.links.length - 1].url)"
                    >
